      ...
      case "arrearsAging":
        return (
          <Box>
            ...
            <Button variant="outlined" color="secondary" sx={{ mt: 2 }} onClick={exportArrearsAging}>Export Arrears CSV</Button>
          </Box>
        );
    ...
    <Box sx={{ p: isMobile ? 1 : 3 }}>
      ...
      <Paper elevation={1} sx={{ p: 2, mb: 3 }}>
        <Stack direction={isMobile ? "column" : "row"} spacing={2} alignItems="center">
          <FormControl size="small" sx={{ minWidth: 200, ...filterInputStyles }}>
                  ...
                  <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          size="small"
                          sx={{ '&.Mui-checked': { color: theme.palette.secondary.main } }} // <-- Accent color for checked state
                        />
                      }
                      label="Active"
                  />
